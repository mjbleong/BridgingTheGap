...
var photoSchema = new mongoose.Schema({
    id: String,     // Unique ID identifying this user - actually photo _id
    ...
    user_id: mongoose.Schema.Types.ObjectId, // The user object of the user who created the photo. - actually userid
